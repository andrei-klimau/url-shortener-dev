  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title">{{ __('common.please_confirm') }}</h5>
      </div>
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-primary" data-bs-dismiss="modal" data-role="modal-confirm-btn-yes">{{ __('common.yes') }}</button>
